...
folder are mapped to the application's root namespace, 'cardioCatalogQT'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "cardioCatalogQT"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'cardioCatalogQT' in the same way
as `"cardioCatalogQT/sass/src"`.
